...
export const botConfigSchema = z.object({
  ...
  investmentPercentage: z.number().min(1).max(100).default(10),
...
export const bots = pgTable("bots", {
  ...
  usePercentage: boolean("use_percentage").notNull().default(false),
  investmentPercentage: real("investment_percentage").notNull().default(10),
